...
👉 **For reverse model documentation**, see [README_REVERSE.md](README_REVERSE.md) or switch to the `reverse-structured-extraction` branch.
...
- **master** (main branch): Forward model implementation
